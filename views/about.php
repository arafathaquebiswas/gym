...
<section class="hero page-hero">
  <div class="container text-center">
    <div class="hero-copy">
      <span class="hero-badge">About POWERSURGE GYM & NUTRITION</span>
      <h1>Built for People Who <span class="text-orange">Show Up</span></h1>
      <p class="hero-subtitle">POWERSURGE GYM & NUTRITION opened its doors with one goal: give every member — beginner or competitive athlete — the tools, coaching, and community to keep training hard for the long run.</p>
    </div>
  </div>
</section>
    ...
    <div class="row g-5 align-items-center">
      <div class="col-lg-6">
        <div style="min-height:340px;border-radius:var(--ps-radius);overflow:hidden">
          <img src="<?= asset('images/gyminterior/gyminterior3.jpg') ?>" alt="POWERSURGE GYM & NUTRITION training floor" class="photo-tile" style="min-height:340px">
        </div>
      </div>
      <div class="col-lg-6">
        <h2 class="section-title">Our Story</h2>
        <p class="text-white-50">POWERSURGE GYM & NUTRITION started as a single training floor and has grown into a full-service fitness center with strength equipment, group classes, personal training, and a nutrition-focused supplement store — all under one roof.</p>
